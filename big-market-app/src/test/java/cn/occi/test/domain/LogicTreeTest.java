...
public class LogicTreeTest {
    @Resource
    private TreeNodeFactory defaultTreeFactory;
    ...
    public void test_tree_rule() {
        ...
        IDecisionEngine treeEngine = defaultTreeFactory.openDecisionEngine(ruleTreeVO);

        TreeNodeFactory.StrategyAwardData data = treeEngine.process("xiaofuge", 100001L, 100);
